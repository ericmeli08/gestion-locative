<template>
  <GuestLayout>
    ...
    <div
      class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8"
    >
      <div class="max-w-md w-full space-y-8">
        <!-- Logo et titre -->
        <div class="text-center">
          <div
            class="mx-auto h-16 w-16 bg-primary-600 rounded-xl flex items-center justify-center shadow-lg"
          >
            <KeyIcon class="h-8 w-8 text-white" />
          </div>
          <h2 class="mt-6 text-3xl font-bold text-gray-900 dark:text-white">Mot de passe oublié</h2>
        ...
        <div
          v-if="status"
          class="bg-success-50 dark:bg-success-900/50 border border-success-200 dark:border-success-800 rounded-lg p-4"
        >
          <div class="flex">
        ...
        <!-- Formulaire -->
        <div
          class="bg-white dark:bg-gray-800 shadow-card-hover rounded-2xl p-8 border border-gray-200 dark:border-gray-700"
        >
