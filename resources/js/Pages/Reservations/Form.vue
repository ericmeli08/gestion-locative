            ...
            <form @submit.prevent="submit" class="space-y-6 p-6">
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p v-if="errors?.plateforme" class="mt-1 text-sm text-red-600">{{ errors?.plateforme }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p v-if="errors?.appartement_id" class="mt-1 text-sm text-red-600">{{ errors?.appartement_id }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p v-if="errors?.prix_nuit" class="mt-1 text-sm text-red-600">{{ errors?.prix_nuit }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p v-if="errors?.date_entree" class="mt-1 text-sm text-red-600">{{ errors?.date_entree }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        />
                        <p v-if="errors?.date_sortie" class="mt-1 text-sm text-red-600">{{ errors?.date_sortie }}</p>
                    </div>
                </div>
                ...
                <div v-if="form.statut_paiement === 'paid'">
                    ...
                    />
                    <p v-if="errors?.date_paiement" class="mt-1 text-sm text-red-600">{{ errors?.date_paiement }}</p>
                </div>
...
watch(() => form.statut_paiement, (newStatus) => {
