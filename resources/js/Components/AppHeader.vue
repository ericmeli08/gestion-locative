      ...
      <div class="flex h-16 justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
          ...
          >
            ...
            <span
              v-if="unreadCount > 0"
              class="absolute -top-1 -right-1 block h-4 w-4 rounded-full bg-red-500 text-xs font-medium text-white text-center leading-4"
            >
          ...
          <Menu as="div" class="relative">
            <MenuButton
              class="flex max-w-xs items-center rounded-full bg-gray-100 dark:bg-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
            >
              <img
...
import { Bars3Icon, BellIcon, ChevronRightIcon } from '@heroicons/vue/24/outline'
