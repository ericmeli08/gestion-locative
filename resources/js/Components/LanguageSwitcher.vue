<template>
    <Menu as="div" class="relative">
        <MenuButton class="flex items-center rounded-md p-2 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:text-gray-300 dark:hover:text-gray-200">
                    ...
                    <MenuItem v-for="lang in availableLanguages" :key="lang.code" v-slot="{ active }">
                        <button
                            ...
                            :class="[
                                ...
                                currentLanguage === lang.code ? 'bg-primary-50 text-primary-600 dark:bg-primary-900/50 dark:text-primary-400' : 'text-gray-700 dark:text-gray-300',
