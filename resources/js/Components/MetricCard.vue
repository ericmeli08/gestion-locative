<template>
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-card hover:shadow-card-hover dark:shadow-card-dark dark:hover:shadow-card-hover-dark rounded-xl transition-all duration-300 hover:scale-105 border border-gray-200 dark:border-gray-700 animate-fade-in">
        <div class="p-6">
                    ...
                    <dl>
                        ...
                        <dd class="flex items-baseline">
                            ...
                            <div v-if="trend" :class="[
                                ...
                                trendType === 'positive' ? 'text-success-600 dark:text-success-400' : 'text-error-600 dark:text-error-400'
                            ]">
                                <component 
